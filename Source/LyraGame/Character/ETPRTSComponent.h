...
#include "ETPRTSComponent.generated.h"
...
class LYRAGAME_API UETPRTSComponent : public UPawnComponent, public IGameFrameworkInitStateInterface
{
	GENERATED_BODY()

public:

	UETPRTSComponent(const FObjectInitializer& ObjectInitializer);

	/** Returns the hero component if one exists on the specified actor. */
	UFUNCTION(BlueprintPure, Category = "EPT|RTS")
	static UETPRTSComponent* FindRTSComponent(const AActor* Actor) { return (Actor ? Actor->FindComponentByClass<UETPRTSComponent>() : nullptr); }
