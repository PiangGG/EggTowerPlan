...
#include "ETPGameplayAbility_Interact.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(ETPGameplayAbility_Interact)

UE_DEFINE_GAMEPLAY_TAG_STATIC(TAG_Ability_Interaction_Activate, "Ability.Interaction.Activate");
UE_DEFINE_GAMEPLAY_TAG(TAG_INTERACTION_DURATION_MESSAGE, "Ability.Interaction.Duration.Message");

UETPGameplayAbility_Interact::UETPGameplayAbility_Interact(const FObjectInitializer& ObjectInitializer)
...
void UETPGameplayAbility_Interact::ActivateAbility(const FGameplayAbilitySpecHandle Handle,
...
void UETPGameplayAbility_Interact::UpdateInteractions(const TArray<FInteractionOption>& InteractiveOptions)
{
...
void UETPGameplayAbility_Interact::TriggerInteraction()
{
